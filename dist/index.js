...
if (process.env.NODE_ENV === 'production') {
    clientPromise = mongodb_1.MongoClient.connect(MONGODB_URI, { maxPoolSize: 1 });
}
else {
    if (!global._mongoClientPromise) {
        ;
        global._mongoClientPromise = mongodb_1.MongoClient.connect(MONGODB_URI, { maxPoolSize: 10 });
    }
